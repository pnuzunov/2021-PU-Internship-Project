...
namespace Budget_Calculator.Components
{
    public partial class PieChartControl<T> : UserControl
    {
        private Color[] availableColors;

        public PieChartControl(ICollection<T> data, Func<T, object> whichGroup, object[] groups)
        {
            InitializeComponent();
